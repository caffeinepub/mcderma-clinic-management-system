...
export class Backend implements backendInterface {
    ...
    async assignDoctorToAppointment(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignDoctorToAppointment(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStaffByRole(arg0: string): Promise<Array<Staff>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStaffByRole(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
