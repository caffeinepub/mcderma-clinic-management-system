      ...
      <CardContent className="p-1">
        <div className="flex items-start justify-between gap-1">
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-xs mb-0 truncate leading-none">{lead.leadName}</h3>
            <button 
              onClick={handleCall}
              className="text-xs text-muted-foreground flex items-center gap-0.5 mt-0.5 hover:text-primary transition-colors cursor-pointer"
            >
        ...
        <div className="mt-1 space-y-0.5">
          <div className="flex items-center gap-1 text-xs">
            ...
            <Badge variant="secondary" className="text-xs h-4 px-1">{lead.treatmentWanted}</Badge>
          </div>
          ...
          {lead.doctorRemark && (
            <div className="text-xs bg-muted/50 rounded-md p-1 mt-0.5">
        ...
        <div className="flex flex-wrap gap-0.5 mt-1">
          <Button size="sm" variant="outline" onClick={handleCall} className="h-5 text-xs px-1.5 py-0">
            <Phone className="h-2 w-2 mr-0.5" />
            Call
          </Button>
          <Button size="sm" variant="outline" onClick={handleWhatsApp} className="h-5 text-xs px-1.5 py-0">
            <MessageCircle className="h-2 w-2 mr-0.5" />
            WhatsApp
          </Button>
          <Button size="sm" variant="outline" onClick={() => onEdit(lead)} className="h-5 text-xs px-1.5 py-0">
            <Edit className="h-2 w-2 mr-0.5" />
            Edit
          </Button>
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button size="sm" variant="outline" className="h-5 text-xs px-1.5 py-0 text-destructive hover:text-destructive">
